...
- Observability is the ability to understand the internal state of a system`(application,infra,network)` by analyzing the data it produces, including logs, metrics, and traces.
